...
function showMainMenu() {
    ...
    if (canvas) canvas.classList.add('hidden'); // Hide canvas while on menu
...
function startGame() {
    ...
    if (canvas) canvas.classList.remove('hidden'); // Show canvas when playing
    if (gameOverScreen) gameOverScreen.classList.add('hidden');
...
function showGameOverScreen() {
    ...
    if (canvas) canvas.classList.add('hidden'); // Hide canvas on game over
    if (mainMenu) mainMenu.classList.add('hidden'); // Ensure main menu is hidden
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Also check for mainMenu and gameOverScreen for robustness
